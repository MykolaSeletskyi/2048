...
{
    // Клас дає можливість створити команду
    // передавши в конструктор в якості параметра делегат
    // який містить алгоритм роботи команди та перевірки на доступність
